...
from pre_data import pad_sequences, batch_yield,get_logger
...
class BiLSTM_CRF(object):
    def __init__(self, batch_size, epoch_num, hidden_dim, embeddings,
                 ...
                 model_path, summary_path, log_path, result_path,flag,
                 CRF=False, update_embedding=True):
    ...
    def biLSTM_layer_op(self):
        if self.flag:
            ...
            output_seq,_ = tf.nn.dynamic_rnn(lstm_cell,
